/** 싯헤드 최대 시작 인원 — 52장 덱에서 1인당 9장(바닥 3+손 6)을 나눠줄 수 있는 한계(5×9=45). */
export const SHITHEAD_MAX_PLAYERS = 5;

/** 조커 2장을 넣은 54장 덱에서 시작할 수 있는 최대 인원 (6×9=54). */
export const SHITHEAD_MAX_PLAYERS_WITH_JOKERS = 6;
